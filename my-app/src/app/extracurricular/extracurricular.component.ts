...
export class ExtracurricularComponent implements OnInit {
    ...
    ngAfterViewInit() {
        console.log("Loading extracurricular.json to pass to sections.");
        // grab data on each section
        this.httpService.get('../assets/data/extracurricular.json').subscribe(
            data => {
                this.organizations = data as string [];
